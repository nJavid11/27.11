        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BgText = table.Column<string>(type: "ntext", nullable: true),
                    BgImage = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    BgTitle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Info = table.Column<string>(type: "ntext", nullable: true),
                    Button = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkCards", x => x.Int);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Info = table.Column<string>(type: "ntext", nullable: true),
                    Star = table.Column<int>(type: "int", maxLength: 5, nullable: false),
